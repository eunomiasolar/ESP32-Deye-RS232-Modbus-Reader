...
@defgroup setup ModbusMaster232 Object Instantiation/Initialization
@defgroup buffer ModbusMaster232 Buffer Management
...
/*
  ...
  ModbusMaster232.h - Arduino library for communicating with Modbus slaves
...
class ModbusMaster232
{
  public:
    ...
    */
    ...
    /**
    ModbusMaster232 invalid response slave ID exception.
    ...
    */
    ...
    /**
    ModbusMaster232 invalid response function exception.
    ...
    */
    ...
    /**
    ModbusMaster232 response timed out exception.
    
    The entire response was not received within the timeout period, 
    ModbusMaster232::ku8MBResponseTimeout. 
    ...
    */
    ...
    /**
    ModbusMaster232 invalid response CRC exception.
    ...
    */
    ...
    static const uint8_t ku8MBPollWaitRx                 = 0xE4;
    static const uint8_t ku8MBPollWaitRest               = 0xE5;
    ...
    uint8_t  readPollHoldingRegisters(uint16_t u16ReadAddress, uint16_t u16ReadQty);
...
/*  
    ...
    11 (0x0B) Get C omm Event Counter (Serial Line only)
    ...
    // Modbus Function 20 () is "Read File Record," byte count range of 07 to F5.
    Field Name  Size  Hex Value Description
    Slave Address   1 Byte  0x01  Target slave device ID.
    Function Code   1 Byte  0x14  Function code 20 ().
    Byte Count      1 Byte  0x07  Total length of the sub-request that follows (7 bytes).
    Reference Type  1 Byte  0x06  Hardcoded standard identifier for "File".
    File Number     2 Bytes 0x00  04 Reading from File #4.
    Record Number   2 Bytes 0x00  01 Starting at Record #1.
    Record Length   2 Bytes 0x00  02 Number of 16-bit registers to read (2 registers).
    CRC             2 Bytes 0xXX XX Cyclic Redundancy Check for error detection.
    ...
    // Modbus Function 21 () for writing file records.
*/
    ...
    uint8_t ModbusMasterPollTransaction(uint8_t u8MBFunction);
